...
## Генерация промпта
Описение генерации происходит в [spec/05](spec/05-prompt-assembly.md), подробнее с ней можно ознакомится там. Также по пути [data/prompts](data/prompts/) можно ознакомиться с промптом для каждой существующей карточки
